package com.fivematch.fivemaster
...
import com.fivematch.fivemaster.databinding.ActivityMainBinding
import com.fivematch.fivemaster.game.utils.gdxGame
import com.fivematch.fivemaster.util.OneTime
import com.fivematch.fivemaster.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.eloNpc)
    fun getPryvURL() = getString(R.string.dy3hBbsI)
