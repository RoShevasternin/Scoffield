package com.sandtro.trintity.game.utils.actor
...
import com.sandtro.trintity.game.actors.main.AMainSett
import com.sandtro.trintity.game.manager.util.SoundUtil
import com.sandtro.trintity.game.utils.Acts
import com.sandtro.trintity.game.utils.SizeScaler
...
fun Actor.setOnClickListener(
    ...
    addListener(object : InputListener() {
        ...
        override fun touchDown(event: InputEvent?, x: Float, y: Float, pointer: Int, button: Int): Boolean {
            if (AMainSett.isVib) Gdx.input.vibrate(100)
