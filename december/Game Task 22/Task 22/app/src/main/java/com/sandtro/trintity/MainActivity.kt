...
import com.sandtro.trintity.databinding.ActivityMainBinding
import com.sandtro.trintity.game.utils.gdxGame
import com.sandtro.trintity.util.OneTime
import com.sandtro.trintity.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.brama)
    fun getPrivacyURL() = getString(R.string.ecvator)
