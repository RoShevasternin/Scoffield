...
import com.totempair.advenroute.game.GDX_GLOBAL_isGame
import com.totempair.advenroute.game.GDX_GLOBAL_isLoadAssets
import com.totempair.advenroute.game.actors.main.AMainLoader
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun loadSplashAssets() {
        with(gdxGame.spriteManager) {
            ...
            loadAtlas()
            //loadableTexturesList = mutableListOf(SpriteManager.EnumTexture.L_BACKGROUND.data,)
            //loadTexture()
        }
