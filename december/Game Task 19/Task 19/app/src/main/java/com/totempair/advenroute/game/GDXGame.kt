package com.totempair.advenroute.game
...
import com.totempair.advenroute.MainActivity
import com.totempair.advenroute.appContext
import com.totempair.advenroute.game.manager.MusicManager
import com.totempair.advenroute.game.manager.NavigationManager
import com.totempair.advenroute.game.manager.SoundManager
import com.totempair.advenroute.game.manager.SpriteManager
import com.totempair.advenroute.game.manager.util.MusicUtil
import com.totempair.advenroute.game.manager.util.SoundUtil
import com.totempair.advenroute.game.manager.util.SpriteUtil
import com.totempair.advenroute.game.screens.LoaderScreen
import com.totempair.advenroute.game.utils.GameColor
import com.totempair.advenroute.game.utils.advanced.AdvancedGame
import com.totempair.advenroute.game.utils.disposeAll
import com.totempair.advenroute.util.Gist
import com.totempair.advenroute.util.log
...
class GDXGame(val activity: MainActivity) : AdvancedGame() {
    ...
    val sharedPreferences: SharedPreferences = appContext.getSharedPreferences("Prafesder", MODE_PRIVATE)
