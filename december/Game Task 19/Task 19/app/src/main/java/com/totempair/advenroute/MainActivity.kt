package com.totempair.advenroute
...
import com.totempair.advenroute.databinding.ActivityMainBinding
import com.totempair.advenroute.game.utils.gdxGame
import com.totempair.advenroute.util.OneTime
import com.totempair.advenroute.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.ad45safe)
    fun getPrivacyURL() = getString(R.string.pyrsc)
