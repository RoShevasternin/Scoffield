package com.tikispit.ilets.game.actors.button
...
import com.tikispit.ilets.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Back -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.bd),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.bp),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.bp),
        )
    }
