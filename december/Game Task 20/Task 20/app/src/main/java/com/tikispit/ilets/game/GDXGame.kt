package com.tikispit.ilets.game
...
import com.tikispit.ilets.MainActivity
import com.tikispit.ilets.appContext
import com.tikispit.ilets.game.manager.MusicManager
import com.tikispit.ilets.game.manager.NavigationManager
import com.tikispit.ilets.game.manager.SoundManager
import com.tikispit.ilets.game.manager.SpriteManager
import com.tikispit.ilets.game.manager.util.MusicUtil
import com.tikispit.ilets.game.manager.util.SoundUtil
import com.tikispit.ilets.game.manager.util.SpriteUtil
import com.tikispit.ilets.game.screens.LoaderScreen
import com.tikispit.ilets.game.utils.GameColor
import com.tikispit.ilets.game.utils.advanced.AdvancedGame
import com.tikispit.ilets.game.utils.disposeAll
import com.tikispit.ilets.util.Gist
import com.tikispit.ilets.util.log
...
class GDXGame(val activity: MainActivity) : AdvancedGame() {
    ...
    val sharedPreferences: SharedPreferences = appContext.getSharedPreferences("Posted", MODE_PRIVATE)
    ...
    private fun statMessageForJeack() {
        ...
        val savedData = sharedPreferences.getString("brod", "blue") ?: "blue"
