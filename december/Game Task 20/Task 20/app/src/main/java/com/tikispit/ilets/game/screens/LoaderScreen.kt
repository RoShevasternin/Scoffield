...
import com.tikispit.ilets.game.GDX_GLOBAL_isGame
import com.tikispit.ilets.game.GDX_GLOBAL_isLoadAssets
import com.tikispit.ilets.game.actors.main.AMainLoader
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun toGame() {
        ...
        gdxGame.musicUtil.apply { currentMusic = Bampiamp.apply {
            isLooping = true
            coff      = 0.40f
        } }
