package com.watermil.terwater.game.actors.checkbox
...
import com.watermil.terwater.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.Mus -> ACheckBoxStyle(
            default = gdxGame.assetsAll.md,
            checked = gdxGame.assetsAll.mp,
        )
        Type.Sod -> ACheckBoxStyle(
            default = gdxGame.assetsAll.sd,
            checked = gdxGame.assetsAll.sp,
        )
    }
