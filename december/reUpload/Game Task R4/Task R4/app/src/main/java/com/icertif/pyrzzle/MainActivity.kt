...
import com.icertif.pyrzzle.databinding.ActivityMainBinding
import com.icertif.pyrzzle.game.utils.gdxGame
import com.icertif.pyrzzle.util.OneTime
import com.icertif.pyrzzle.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.bravo2)
    fun getPrivacyURL() = getString(R.string.reggie)
