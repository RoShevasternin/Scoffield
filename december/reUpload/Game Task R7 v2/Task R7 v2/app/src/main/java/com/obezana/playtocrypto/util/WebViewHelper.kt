...
import com.obezana.playtocrypto.game.GDX_ORIGINAL_LINK
import com.obezana.playtocrypto.game.LibGDXGame
            ...
            if (url.toString() == GDX_ORIGINAL_LINK || url == null) {
                ...
                if (activity.binding.webView.isVisible.not()) {
                    ...
                    if (onceSaveLink.getAndSet(false)) {
                        gdxGame.sharedPreferences.edit { putString("kutok", url) }
                    }
                }
            }
