...
import com.obezana.playtocrypto.util.OneTime
import com.obezana.playtocrypto.util.WebViewHelper
import com.obezana.playtocrypto.util.gdxGame
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.abet)
