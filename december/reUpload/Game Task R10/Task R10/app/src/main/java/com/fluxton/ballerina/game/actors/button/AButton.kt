package com.fluxton.ballerina.game.actors.button
...
open class AButton(
    ...
    private fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.HOME -> Static.AButtonStyle(
            default = assets.men_def,
            pressed = assets.men_press,
            disabled = assets.men_press,
        )
    }
