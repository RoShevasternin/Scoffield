...
import com.dliw.drib.databinding.ActivityMainBinding
import com.dliw.drib.util.OneTime
import com.dliw.drib.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.reggras)
