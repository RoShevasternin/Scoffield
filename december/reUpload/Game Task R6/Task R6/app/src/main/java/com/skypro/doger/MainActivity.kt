...
import com.skypro.doger.databinding.ActivityMainBinding
import com.skypro.doger.game.utils.gdxGame
import com.skypro.doger.util.OneTime
import com.skypro.doger.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.lolerta)
