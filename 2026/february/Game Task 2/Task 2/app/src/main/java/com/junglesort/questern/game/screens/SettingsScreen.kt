...
import com.junglesort.questern.game.actors.checkbox.ACheckBox
import com.junglesort.questern.game.actors.progress.AProgress
...
class SettingsScreen: AdvancedScreen() {
    ...
    private fun Group.addGroupSettings() {
        groupSettings.setSize(990f, 1318f)
    ...
    private fun Group.addBtnBack() {
        addActor(btnBack)
        btnBack.setBounds(398f, 0f, 179f, 179f)
    ...
    private fun Group.addAProgress() {
        addActor(progress)
        progress.setBounds(262f, 783f, 463f, 60f)
