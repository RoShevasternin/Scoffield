package com.junglesort.questern
...
import com.junglesort.questern.databinding.ActivityMainBinding
import com.junglesort.questern.util.OneTime
import com.junglesort.questern.util.WebViewHelper
...
//            }
    ...
    fun openPlayMarket() {
        val intent = Intent(Intent.ACTION_VIEW, "https://play.google.com/store/apps/details?id=${appContext.packageName}".toUri())
        startActivity(intent)
    }
