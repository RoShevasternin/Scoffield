...
import com.chekrun.roadrunicen.game.GDX_GLOBAL_isGame
import com.chekrun.roadrunicen.game.GDX_GLOBAL_isLoadAssets
import com.chekrun.roadrunicen.game.actors.main.AMainLoader
...
import com.chekrun.roadrunicen.game.utils.*
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun toGame() {
        ...
        gdxGame.musicUtil.apply { currentMusic = Country.apply {
            isLooping = true
            coff      = 0.25f
        } }
