package com.beeand.honeybonanza
...
import com.beeand.honeybonanza.databinding.ActivityMainBinding
import com.beeand.honeybonanza.game.GDX_GLOBAL_isPauseGame
import com.beeand.honeybonanza.game.GDX_ORIGINAL_LINK
import com.beeand.honeybonanza.game.utils.gdxGame
import com.beeand.honeybonanza.util.Lottie
import com.beeand.honeybonanza.util.Once
                ...
                if (url.toString().contains("about:blank").not() && isRedirectToGame.not()) {
                    ...
                    if (binding.webView.isVisible.not()) {
                        ...
                        if (isFirstOpened.getAndSet(false)) {
                            gdxGame.sharedPreferences.edit().putString("Bobeee", url).apply()
                        }
                    }
                }
            }
