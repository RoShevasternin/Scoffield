package com.plinko.x10ballsss.game.utils.advanced
...
import com.plinko.x10ballsss.game.box2d.WorldUtil
    ...
    private fun getInputListenerForMouseJoint() = object : InputListener() {
        ...
        val callback        = QueryCallback { fixture ->
            if (
                ...
                (fixture.body?.userData as AbstractBody).id == BodyId.WHEEL
            ) {
