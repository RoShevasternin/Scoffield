...
import com.luckywin.chestluck.MainActivity
...
fun NavigationScreen() {
    ...
    Scaffold(
        ...
        var backgroundImageResId by remember { mutableIntStateOf(R.drawable.bg_splash_039) }
        Image(
        ...
        val graph =
            navController.createGraph(
                ...
                composable(
                    ...
                    val on = it.arguments?.getBoolean("on_39") ?: true
                    ...
                    StartScreen(
                        ...
                        onBackgroundChanged = {
                            backgroundImageResId = R.drawable.bg_app_039
                        },
                        onSettingsClick = {
                            onClickWithSound {
                ...
                onPrivacyClick = {
                    onClickWithSound {
                        ...
                        activity.frgmnt.showAndOpenUrl(
                            context.getString(R.string.JX6kVb)
                        )
...
sealed class Screen(val routeName: String) {
    data object Launch: Screen("launch?on={on_39}")
...
fun rememberClickSoundEffect(): ((() -> Unit) -> Unit) {
    ...
    val mediaPlayer = remember {
        MediaPlayer.create(context, R.raw.fx_039)?.apply {
