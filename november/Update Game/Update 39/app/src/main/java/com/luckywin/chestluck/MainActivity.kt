...
import com.luckywin.chestluck.LuckyWin39Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: LuckyWin39Helper
    lateinit var frgmnt: LuckyWin39Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = LuckyWin39Helper(this, lifecycleScope)
        frgmnt = LuckyWin39Fragment(this, helper)
