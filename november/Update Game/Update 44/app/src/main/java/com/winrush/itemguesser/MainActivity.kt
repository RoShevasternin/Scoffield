package com.winrush.itemguesser
...
import com.winrush.itemguesser.WinRush44Helper.Companion.FRAGMENT_ID
import com.winrush.itemguesser.databinding.ActivityMainBinding
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class MainActivity : AppCompatActivity() {

    private lateinit var helper: WinRush44Helper
    lateinit var frgmnt: WinRush44Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = WinRush44Helper(this, lifecycleScope)
        frgmnt = WinRush44Fragment(this, helper)
