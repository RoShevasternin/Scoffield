...
import com.winrush.itemguesser.MainActivity
...
fun NavigationScreen() {
    ...
    Scaffold(
        ...
        var backgroundImageResId by remember { mutableIntStateOf(R.drawable.bg_splash_044) }
        Image(
            ...
            navController.createGraph(
                ...
                composable(
                    ...
                    StartScreen(
                        ...
                        onBackgroundChanged = {
                            backgroundImageResId = R.drawable.bg_app_044
                        },
                        onSettingsClick = {
                            onClickWithSound {
                        ...
                        onPrivacyClick = {
                            onClickWithSound {
                                ...
                                activity.frgmnt.showAndOpenUrl(
                                    context.getString(R.string.LqQr57)
                                )
...
fun rememberClickSoundEffect(): ((() -> Unit) -> Unit) {
    ...
    val mediaPlayer = remember {
        MediaPlayer.create(context, R.raw.fx_044)?.apply {
