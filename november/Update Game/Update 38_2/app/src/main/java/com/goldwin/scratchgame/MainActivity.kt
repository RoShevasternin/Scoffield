...
import com.goldwin.scratchgame.GoldWin3802Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: GoldWin3802Helper
    lateinit var frgmnt: GoldWin3802Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = GoldWin3802Helper(this, lifecycleScope)
        frgmnt = GoldWin3802Fragment(this, helper)
