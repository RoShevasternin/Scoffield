...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: WinGam38Helper
    lateinit var frgmnt: WinGam38Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = WinGam38Helper(this, lifecycleScope)
        frgmnt = WinGam38Fragment(this, helper)
