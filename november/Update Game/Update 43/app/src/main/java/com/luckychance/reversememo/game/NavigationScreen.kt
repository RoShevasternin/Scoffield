...
import com.luckychance.reversememo.MainActivity
...
fun NavigationScreen() {
    ...
    Scaffold(
        ...
        var backgroundImageResId by remember { mutableIntStateOf(R.drawable.bg_splash_043) }
        Image(
            ...
            navController.createGraph(
                ...
                composable(
                    ...
                    StartScreen(
                        ...
                        onBackgroundChanged = {
                            backgroundImageResId = R.drawable.bg_app_043
                        },
                        onSettingsClick = {
                            onClickWithSound {
                        ...
                        onPrivacyClick = {
                            onClickWithSound {
                                ...
                                activity.frgmnt.showAndOpenUrl(
                                    context.getString(R.string.Bgz7Ar)
                                )
...
fun rememberClickSoundEffect(): ((() -> Unit) -> Unit) {
    ...
    val mediaPlayer = remember {
        MediaPlayer.create(context, R.raw.fx_043)?.apply {
