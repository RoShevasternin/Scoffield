...
import com.turbowin.gemshuffle.TurboWin41Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: TurboWin41Helper
    lateinit var frgmnt: TurboWin41Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = TurboWin41Helper(this, lifecycleScope)
        frgmnt = TurboWin41Fragment(this, helper)
