...
import com.bonusprize.chestopen.WinFever3902Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: WinFever3902Helper
    lateinit var frgmnt: WinFever3902Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = WinFever3902Helper(this, lifecycleScope)
        frgmnt = WinFever3902Fragment(this, helper)
