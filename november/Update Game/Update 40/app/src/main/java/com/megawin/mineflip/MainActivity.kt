...
import com.megawin.mineflip.MegaWin40Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: MegaWin40Helper
    lateinit var frgmnt: MegaWin40Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = MegaWin40Helper(this, lifecycleScope)
        frgmnt = MegaWin40Fragment(this, helper)
