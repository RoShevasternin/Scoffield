...
import com.bonanza.pazzleground.game.GDX_GLOBAL_isGame
import com.bonanza.pazzleground.game.GDX_GLOBAL_isLoadAssets
import com.bonanza.pazzleground.game.actors.main.AMainLoader
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun toGame() {
        ...
        hideScreen {
            gdxGame.navigationManager.navigate(MenushkaScreen::class.java.name)
        }
    }
