package com.plinki.kollinllabs.game.actors.button
...
import com.plinki.kollinllabs.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Play -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.p_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.p_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.p_p),
        )
        Type.Rules -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.r_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.r_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.r_p),
        )
        Type.Exit -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.e_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.e_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.e_p),
        )
        Type.Back -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.b_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.b_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.b_p),
        )
    }
