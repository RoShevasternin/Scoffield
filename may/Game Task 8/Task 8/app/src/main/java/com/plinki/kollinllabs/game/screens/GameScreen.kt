...
import com.plinki.kollinllabs.game.actors.checkbox.ACheckBox
import com.plinki.kollinllabs.game.box2d.AbstractBody
import com.plinki.kollinllabs.game.box2d.BodyId
import com.plinki.kollinllabs.game.box2d.WorldUtil
import com.plinki.kollinllabs.game.box2d.bodies.BBall
import com.plinki.kollinllabs.game.box2d.bodies.BCircle
import com.plinki.kollinllabs.game.box2d.bodies.BFinishSensor
import com.plinki.kollinllabs.game.box2d.bodies.BPlayground
import com.plinki.kollinllabs.game.utils.*
import com.plinki.kollinllabs.game.utils.actor.animHide
import com.plinki.kollinllabs.game.utils.actor.animShow
import com.plinki.kollinllabs.game.utils.actor.disable
...
class GameScreen() : AdvancedBox2dScreen(WorldUtil()) {
    ...
    override fun show() {
        ...
        //setBackBackground(gdxGame.assetsAll.GAME.region)
        super.show()
            ...
            win.beginContactBlockArray.add(AbstractBody.ContactBlock { enemy ->
                if (enemy.id == BodyId.Game.BALL) {
                    ...
                    if (enemy.isFirst.getAndSet(false)) {
                        runGDX {
                            gdxGame.soundUtil.apply { play(loss) }
