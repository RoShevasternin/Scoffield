package com.bonanza.twoursenderson.game.actors.button
...
import com.bonanza.twoursenderson.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Exit -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.ex_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.ex_press),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.ex_press),
        )
