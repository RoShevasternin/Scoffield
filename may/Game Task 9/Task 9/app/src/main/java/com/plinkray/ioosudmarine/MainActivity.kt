package com.plinkray.ioosudmarine
...
import com.plinkray.ioosudmarine.databinding.ActivityMainBinding
import com.plinkray.ioosudmarine.game.GDX_GLOBAL_isPauseGame
import com.plinkray.ioosudmarine.game.utils.gdxGame
import com.plinkray.ioosudmarine.util.OneTime
import com.plinkray.ioosudmarine.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    private inner class WebClient : WebViewClient() {
        override fun shouldOverrideUrlLoading(
            ...
            if (request?.url.toString().contains("https://pinker")) {
