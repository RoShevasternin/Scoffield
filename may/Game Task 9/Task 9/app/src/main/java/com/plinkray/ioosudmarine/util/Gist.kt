...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/nikaapps13/dd725ddd2cd653c74fb847a1838d78a2/raw/task9"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    flag = json.optString("because", ""),
                    link = json.optString("soldier", ""),
                )
            } else {
