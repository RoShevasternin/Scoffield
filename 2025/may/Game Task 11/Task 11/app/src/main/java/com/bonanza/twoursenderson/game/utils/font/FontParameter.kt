package com.bonanza.twoursenderson.game.utils.font
...
class FontParameter : FreeTypeFontParameter() {
    ...
    enum class CharType(val chars: String) {
        ...
        TURKEY        ("AaBbCcÇçDdEeFfGgĞğHhIıİiJjKkLlMmNnOoÖöPpRrSsŞşTtUuÜüVvYyZz"),

        LATIN_CYRILLIC(LATIN.chars.plus(CYRILLIC.chars)                                         ),
        ALL           (SYMBOLS.chars.plus(NUMBERS.chars).plus(LATIN.chars).plus(CYRILLIC.chars).plus(TURKEY.chars) ),
    }
