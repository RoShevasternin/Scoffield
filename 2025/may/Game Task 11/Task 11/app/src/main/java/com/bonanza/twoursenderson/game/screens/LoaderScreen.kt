...
import com.bonanza.twoursenderson.game.GDX_GLOBAL_isGame
import com.bonanza.twoursenderson.game.GDX_GLOBAL_isLoadAssets
import com.bonanza.twoursenderson.game.actors.main.AMainLoader
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun toGame() {
        ...
        gdxGame.musicUtil.apply { currentMusic = KIDSMUS.apply {
            isLooping = true
            coff      = 0.181f
        } }
