package com.bonanza.pazzleground.game.actors.button
...
import com.bonanza.pazzleground.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Play -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.pladef),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.plpress),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.plpress),
        )
        Type.Rules -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.rd),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.rp),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.rp),
        )
        Type.Exit -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.exd),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.exp),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.exp),
        )
        Type.Menu -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.mendef),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.menprs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.menprs),
        )
    }
