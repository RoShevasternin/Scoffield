package com.bonanza.pazzleground.game.actors.puzzle
...
import com.bonanza.pazzleground.game.utils.puzzle.NumberPuzzles
...
class APuzzlePanel(
    ...
    private fun getNumberPuzzlesByLevel() = NumberPuzzles._3x3
