...
import com.plinkray.ioosudmarine.game.GDX_GLOBAL_isGame
import com.plinkray.ioosudmarine.game.GDX_GLOBAL_isLoadAssets
import com.plinkray.ioosudmarine.game.actors.main.AMainLoader
...
//        ))
    ...
    private fun toGame() {
        ...
        gdxGame.musicUtil.apply { currentMusic = terraIO.apply {
            isLooping = true
            coff      = 0.275f
        } }
