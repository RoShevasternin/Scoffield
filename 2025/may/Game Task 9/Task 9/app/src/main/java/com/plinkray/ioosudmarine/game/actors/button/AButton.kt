package com.plinkray.ioosudmarine.game.actors.button
...
import com.plinkray.ioosudmarine.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.L1 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.l1_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.l1_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.l1_p),
        )
        Type.L2 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.l2_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.l2_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.l2_p),
        )
        Type.L3 -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.l3_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.l3_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.l3_p),
        )
        Type.Rules -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.rul_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.rul_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.rul_p),
        )
        Type.Exit -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.ex_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.ex_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.ex_p),
        )
        Type.Back -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.bc_d),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.bc_p),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.bc_p),
        )
    }
