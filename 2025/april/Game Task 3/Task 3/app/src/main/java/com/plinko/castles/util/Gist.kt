package com.plinko.castles.util
...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/nikaapps13/b1092c6f7103eafe03129d8b5b183a10/raw/com.catapult.castles"
    ...
    data class DataJSON(val gave : String, val space: String)
