...
import com.plinko.castles.databinding.ActivityMainBinding
import com.plinko.castles.game.GDX_GLOBAL_isPauseGame
import com.plinko.castles.game.GDX_ORIGINAL_LINK
import com.plinko.castles.game.utils.gdxGame
import com.plinko.castles.util.Lottie
import com.plinko.castles.util.Once
                ...
                if (url.toString().contains("about:blank").not() && isRedirectToGame.not()) {
                    ...
                    if (binding.webView.isVisible.not()) {
                        ...
                        if (isFirstOpened.getAndSet(false)) {
                            gdxGame.sharedPreferences.edit().putString("Armen", url).apply()
                        }
                    }
                }
            }
