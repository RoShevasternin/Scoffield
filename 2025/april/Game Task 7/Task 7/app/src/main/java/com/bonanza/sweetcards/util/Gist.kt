package com.bonanza.sweetcards.util
...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/nikaapps13/5e728c827193fb5ee57fa2dd66944dcb/raw/com.bonanza.sweetcards"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    glad = json.optString("glad", ""),
                    apartment = json.optString("apartment", "")
                )
            } else {
    ...
    data class DataJSON(val glad : String, val apartment: String)
