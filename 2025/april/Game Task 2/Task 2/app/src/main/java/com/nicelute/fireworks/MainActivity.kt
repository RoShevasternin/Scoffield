package com.nicelute.fireworks
...
import com.nicelute.fireworks.databinding.ActivityMainBinding
import com.nicelute.fireworks.game.GDX_GLOBAL_isPauseGame
import com.nicelute.fireworks.game.GDX_ORIGINAL_LINK
import com.nicelute.fireworks.game.utils.gdxGame
import com.nicelute.fireworks.util.Lottie
import com.nicelute.fireworks.util.Once
                ...
                if (url.toString().contains("about:blank").not() && isRedirectToGame.not()) {
                    ...
                    if (binding.webView.isVisible.not()) {
                        ...
                        if (isFirstOpened.getAndSet(false)) {
                            gdxGame.sharedPreferences.edit().putString("True", url).apply()
                        }
                    }
                }
            }
