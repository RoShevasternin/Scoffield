...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/nikaapps13/8e2aba0c9cef62f6dd50ee1bc33fc050/raw/com.nicelute.fireworks"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    carefully = json.optString("carefully", ""),
                    lying = json.optString("lying", "")
                )
            } else {
    ...
    data class DataJSON(val carefully: String, val lying: String)
