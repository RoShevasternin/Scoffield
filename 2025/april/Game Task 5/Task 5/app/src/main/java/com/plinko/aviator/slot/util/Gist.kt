...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/nikaapps13/977ff67c8f7af47f977ef9eaec628f6d/raw/com.plinko.aviator.slot"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    hat = json.optString("hat", ""),
                    lower = json.optString("lower", "")
                )
            } else {
    ...
    data class DataJSON(val hat : String, val lower: String)
