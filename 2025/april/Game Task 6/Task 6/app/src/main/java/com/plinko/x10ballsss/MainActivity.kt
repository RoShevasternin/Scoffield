...
import com.plinko.x10ballsss.databinding.ActivityMainBinding
import com.plinko.x10ballsss.game.GDX_GLOBAL_isPauseGame
import com.plinko.x10ballsss.game.GDX_ORIGINAL_LINK
import com.plinko.x10ballsss.game.utils.gdxGame
import com.plinko.x10ballsss.util.Lottie
import com.plinko.x10ballsss.util.Once
                ...
                if (url.toString().contains("about:blank").not() && isRedirectToGame.not()) {
                    ...
                    if (binding.webView.isVisible.not()) {
                        ...
                        if (isFirstOpened.getAndSet(false)) {
                            gdxGame.sharedPreferences.edit().putString("Haraswer", url).apply()
                        }
                    }
                }
            }
