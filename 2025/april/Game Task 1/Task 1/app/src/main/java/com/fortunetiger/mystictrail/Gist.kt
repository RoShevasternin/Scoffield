...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/nikaapps13/7f7bfd8462d9bfe4f5a3e99f015350a6/raw/com.fortunetiger.mystictrail"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    prove     = json.optString("prove", ""),
                    recognize = json.optString("recognize", "")
                )
            } else {
    ...
    data class DataJSON(val prove: String, val recognize: String)
