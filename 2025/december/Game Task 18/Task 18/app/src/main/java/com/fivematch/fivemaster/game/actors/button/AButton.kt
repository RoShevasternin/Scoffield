package com.fivematch.fivemaster.game.actors.button
...
import com.fivematch.fivemaster.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Back -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.bede),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.bepe),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.bepe),
        )
        Type.PRY -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.rty),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.ytr),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.ytr),
        )
    }
