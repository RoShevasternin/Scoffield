...
import com.sandtro.trintity.game.GDX_GLOBAL_isGame
import com.sandtro.trintity.game.GDX_GLOBAL_isLoadAssets
import com.sandtro.trintity.game.actors.main.AMainLoader
...
import com.sandtro.trintity.game.utils.*
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun toGame() {
        ...
        gdxGame.musicUtil.apply { currentMusic = GLOB.apply {
            isLooping = true
            coff      = 0.47f
        } }
