package com.sandtro.trintity.game.actors.checkbox
...
import com.sandtro.trintity.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.OnOff -> ACheckBoxStyle(
            default = gdxGame.assetsAll.on,
            checked = gdxGame.assetsAll.off,
        )
    }
