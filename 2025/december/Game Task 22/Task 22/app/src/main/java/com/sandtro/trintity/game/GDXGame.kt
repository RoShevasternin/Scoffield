package com.sandtro.trintity.game
...
import com.sandtro.trintity.MainActivity
import com.sandtro.trintity.appContext
import com.sandtro.trintity.game.manager.MusicManager
import com.sandtro.trintity.game.manager.NavigationManager
import com.sandtro.trintity.game.manager.SoundManager
import com.sandtro.trintity.game.manager.SpriteManager
import com.sandtro.trintity.game.manager.util.MusicUtil
import com.sandtro.trintity.game.manager.util.SoundUtil
import com.sandtro.trintity.game.manager.util.SpriteUtil
import com.sandtro.trintity.game.screens.LoaderScreen
import com.sandtro.trintity.game.utils.GameColor
import com.sandtro.trintity.game.utils.advanced.AdvancedGame
import com.sandtro.trintity.game.utils.disposeAll
import com.sandtro.trintity.util.Gist
...
class GDXGame(val activity: MainActivity) : AdvancedGame() {
    ...
    val sharedPreferences: SharedPreferences = appContext.getSharedPreferences("Baron", MODE_PRIVATE)
    ...
    private fun ferer() {
        ...
        val savedData = sharedPreferences.getString("lubab", "mint") ?: "mint"
