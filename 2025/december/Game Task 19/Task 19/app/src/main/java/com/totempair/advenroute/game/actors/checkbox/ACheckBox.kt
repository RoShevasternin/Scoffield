package com.totempair.advenroute.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.Mus -> ACheckBoxStyle(
            default = gdxGame.assetsAll.msd,
            checked = gdxGame.assetsAll.mschk,
        )
        Type.Sod -> ACheckBoxStyle(
            default = gdxGame.assetsAll.snd,
            checked = gdxGame.assetsAll.snchk,
        )
        Type.GGG -> ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = gdxGame.assetsAll.ggg.region,
        )
    }
