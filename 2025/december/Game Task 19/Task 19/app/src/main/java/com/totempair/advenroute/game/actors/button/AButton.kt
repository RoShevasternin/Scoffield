package com.totempair.advenroute.game.actors.button
...
import com.totempair.advenroute.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Select -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.sd),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.sp),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.sp),
        )
        Type.X -> AButtonStyle(
        ...
        Type.Privacy -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.ppp),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.ppf),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.ppf),
        )
    }
