package com.filermax.detoxer.game.actors.masks.normal
...
import com.filermax.detoxer.game.utils.zeroScreenVector
...
class Mask(
    ...
    private fun drawScissor(batch: Batch?, parentAlpha: Float) {
        ...
        Gdx.gl.glScissor(mX.toInt() + 1, mY.toInt() + 1, mW.toInt(), mH.toInt())
