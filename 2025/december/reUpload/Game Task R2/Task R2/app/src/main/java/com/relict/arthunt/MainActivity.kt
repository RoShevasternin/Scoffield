...
import com.relict.arthunt.databinding.ActivityMainBinding
import com.relict.arthunt.game.utils.gdxGame
import com.relict.arthunt.util.OneTime
import com.relict.arthunt.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.susanin)
    fun getPrivacyURL() = getString(R.string.prisanyn)
