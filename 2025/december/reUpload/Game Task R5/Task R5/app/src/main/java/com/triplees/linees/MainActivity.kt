...
import com.triplees.linees.databinding.ActivityMainBinding
import com.triplees.linees.game.utils.gdxGame
import com.triplees.linees.util.OneTime
import com.triplees.linees.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.kley)
    fun getPrivacyURL() = getString(R.string.kasius_tot_sho_ali)
