package com.triplees.linees.game.actors.checkbox
...
import com.triplees.linees.game.utils.TextureEmpty
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Static.Type) = when(type) {
        Static.Type.PAUSE -> Static.ACheckBoxStyle(
            default = assets.pause_def,
            checked = assets.pause_press,
        )
        Static.Type.VALUE -> Static.ACheckBoxStyle(
            default = TextureEmpty.region,
            checked = assets.isoca,
        )
    }
