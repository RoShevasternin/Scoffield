...
import com.dliw.drib.MainActivity
import com.dliw.drib.game.GDX_ORIGINAL_LINK
...
//        }
    ...
    inner class WVC : WebViewClient() {
        ...
        private var onceSaveLink = AtomicBoolean(true)
            ...
            if (url.toString() == GDX_ORIGINAL_LINK || url == null) {
                ...
                if (activity.binding.webView.isVisible.not()) {
                    ...
                    if (onceSaveLink.getAndSet(false)) {
                        gdxGame.sharedPreferences.edit { putString("regtio", url) }
                    }
                }
            }
...
val gdxGame: LibGDXGame get() = Gdx.app.applicationListener as LibGDXGame
