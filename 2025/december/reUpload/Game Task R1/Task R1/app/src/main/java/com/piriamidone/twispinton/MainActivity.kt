package com.piriamidone.twispinton
...
import com.piriamidone.twispinton.databinding.ActivityMainBinding
import com.piriamidone.twispinton.game.utils.gdxGame
import com.piriamidone.twispinton.util.OneTime
import com.piriamidone.twispinton.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.abc123)
    fun getPrivacyURL() = getString(R.string.dfg234)
