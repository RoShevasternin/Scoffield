package com.secrofthe.lostpaircret
...
import com.secrofthe.lostpaircret.databinding.ActivityMainBinding
import com.secrofthe.lostpaircret.game.utils.gdxGame
import com.secrofthe.lostpaircret.util.OneTime
import com.secrofthe.lostpaircret.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.netwer)
    fun getPrivacyURL() = getString(R.string.yewsar)
