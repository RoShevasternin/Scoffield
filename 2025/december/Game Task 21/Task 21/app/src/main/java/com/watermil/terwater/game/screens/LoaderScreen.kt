...
import com.watermil.terwater.game.GDX_GLOBAL_isGame
import com.watermil.terwater.game.GDX_GLOBAL_isLoadAssets
import com.watermil.terwater.game.actors.main.AMainLoader
...
import com.watermil.terwater.game.utils.*
...
class LoaderScreen : AdvancedScreen() {
    ...
    private fun toGame() {
        ...
        gdxGame.musicUtil.apply { currentMusic = Water.apply {
            isLooping = true
            coff      = 0.5f
        } }
