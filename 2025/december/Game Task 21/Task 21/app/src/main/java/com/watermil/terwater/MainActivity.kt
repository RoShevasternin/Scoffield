...
import com.watermil.terwater.databinding.ActivityMainBinding
import com.watermil.terwater.game.utils.gdxGame
import com.watermil.terwater.util.OneTime
import com.watermil.terwater.util.WebViewHelper
...
class MainActivity : AppCompatActivity(), AndroidFragmentApplication.Callbacks {
    ...
    fun getGistURL() = getString(R.string.ab123)
    fun getPrivacyURL() = getString(R.string.zx321)
