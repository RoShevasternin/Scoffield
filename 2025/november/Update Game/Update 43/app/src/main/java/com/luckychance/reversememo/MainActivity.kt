...
import com.luckychance.reversememo.LuckyChance43Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: LuckyChance43Helper
    lateinit var frgmnt: LuckyChance43Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = LuckyChance43Helper(this, lifecycleScope)
        frgmnt = LuckyChance43Fragment(this, helper)
