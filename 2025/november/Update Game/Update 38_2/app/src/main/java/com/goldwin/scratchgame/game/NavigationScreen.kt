package com.goldwin.scratchgame.game
...
import com.goldwin.scratchgame.MainActivity
import com.goldwin.scratchgame.R
...
fun NavigationScreen() {
    ...
    Scaffold(
        ...
        var backgroundImageResId by remember { mutableIntStateOf(R.drawable.bg_splash_038) }
        Image(
        ...
        val graph =
            navController.createGraph(
                ...
                composable(
                    ...
                    val on = it.arguments?.getBoolean("on_38") ?: true
                    ...
                    StartScreen(
                        ...
                        onBackgroundChanged = {
                            backgroundImageResId = R.drawable.bg_app_038
                        },
                        onSettingsClick = {
                            onClickWithSound {
                ...
                onPrivacyClick = {
                    onClickWithSound {
                        ...
                        activity.frgmnt.showAndOpenUrl(
                            context.getString(R.string.zWTB3V)
                        )
...
sealed class Screen(val routeName: String) {
    data object Launch: Screen("launch?on={on_38}")
    data object Game: Screen("game?id={id}")
}
...
fun rememberClickSoundEffect(): ((() -> Unit) -> Unit) {
    ...
    val mediaPlayer = remember {
        MediaPlayer.create(context, R.raw.fx_038)?.apply {
