...
import com.bigwin.targetdash.MainActivity
...
fun NavigationScreen() {
    ...
    Scaffold(
        ...
        var backgroundImageResId by remember { mutableIntStateOf(R.drawable.bg_splash_046) }
        Image(
        ...
        val graph =
            navController.createGraph(
                ...
                composable(
                    ...
                    val on = it.arguments?.getBoolean("on_46") ?: true
                    ...
                    StartScreen(
                        ...
                        onBackgroundChanged = {
                            backgroundImageResId = R.drawable.bg_app_046
                        },
                        onSettingsClick = {
                            onClickWithSound {
                        ...
                        onPrivacyClick = {
                            onClickWithSound {
                                ...
                                activity.frgmnt.showAndOpenUrl(
                                    context.getString(R.string.kwA7H3)
                                )
...
sealed class Screen(val routeName: String) {
    data object Launch: Screen("launch?on={on_46}")
...
fun rememberClickSoundEffect(): ((() -> Unit) -> Unit) {
    ...
    val mediaPlayer = remember {
        MediaPlayer.create(context, R.raw.fx_046)?.apply {
