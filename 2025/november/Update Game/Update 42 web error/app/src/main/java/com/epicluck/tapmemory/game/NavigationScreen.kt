...
import com.epicluck.tapmemory.MainActivity
...
fun NavigationScreen() {
    ...
    Scaffold(
        ...
        var backgroundImageResId by remember { mutableIntStateOf(R.drawable.bg_splash_042) }
        Image(
            ...
            navController.createGraph(
                ...
                composable(
                    ...
                    StartScreen(
                        ...
                        onBackgroundChanged = {
                            backgroundImageResId = R.drawable.bg_app_042
                        },
                        onSettingsClick = {
                            onClickWithSound {
                        ...
                        onPrivacyClick = {
                            onClickWithSound {
                                ...
                                activity.frgmnt.showAndOpenUrl(
                                    context.getString(R.string.DtgJ2P)
                                )
...
fun rememberClickSoundEffect(): ((() -> Unit) -> Unit) {
    ...
    val mediaPlayer = remember {
        MediaPlayer.create(context, R.raw.fx_042)?.apply {
