...
import com.epicluck.tapmemory.EpicLuck42Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: EpicLuck42Helper
    lateinit var frgmnt: EpicLuck42Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = EpicLuck42Helper(this, lifecycleScope)
        frgmnt = EpicLuck42Fragment(this, helper)
