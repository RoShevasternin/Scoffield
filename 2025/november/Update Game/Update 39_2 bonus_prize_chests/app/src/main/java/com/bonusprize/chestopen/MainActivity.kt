...
import com.bonusprize.chestopen.BonusPrize3902Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: BonusPrize3902Helper
    lateinit var frgmnt: BonusPrize3902Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = BonusPrize3902Helper(this, lifecycleScope)
        frgmnt = BonusPrize3902Fragment(this, helper)
