...
import com.turbowin.safeunlock.TurboWin45Helper.Companion.FRAGMENT_ID
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var helper: TurboWin45Helper
    lateinit var frgmnt: TurboWin45Fragment
    ...
    private fun makeProcess(binding: ActivityMainBinding) {
        helper = TurboWin45Helper(this, lifecycleScope)
        frgmnt = TurboWin45Fragment(this, helper)
