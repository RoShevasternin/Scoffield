...
import com.turbowin.gemshuffle.MainActivity
...
fun NavigationScreen() {
    ...
    Scaffold(
        ...
        var backgroundImageResId by remember { mutableIntStateOf(R.drawable.bg_splash_041) }
        Image(
            ...
            navController.createGraph(
                ...
                composable(
                    ...
                    StartScreen(
                        ...
                        onBackgroundChanged = {
                            backgroundImageResId = R.drawable.bg_app_041
                        },
                        onSettingsClick = {
                            onClickWithSound {
                        ...
                        onPrivacyClick = {
                            onClickWithSound {
                                ...
                                activity.frgmnt.showAndOpenUrl(
                                    context.getString(R.string.U98mXu)
                                )
...
fun rememberClickSoundEffect(): ((() -> Unit) -> Unit) {
    ...
    val mediaPlayer = remember {
        MediaPlayer.create(context, R.raw.fx_041)?.apply {
