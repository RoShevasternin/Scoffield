package com.order.offortute.game.actors.button
...
import com.order.offortute.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Done -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.done_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.done_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.done_prs),
        )
        Type.Update -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.update_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.update_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.update_prs),
        )
        Type.Menu -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.menu_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.menu_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.menu_prs),
        )
        Type.Sett -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.sett_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.sett_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.sett_prs),
        )
    }
