...
object Gist {
    ...
    private const val URL_STRING = "https://gist.githubusercontent.com/nikaapps13/c813f99109ab70afc8c5b63cc5bde1bc/raw/13v1"
    ...
    suspend fun getDataJson(): DataJSON? = withContext(Dispatchers.IO) {
        try {
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                DataJSON(
                    flag = json.optString("program", ""),
                    link = json.optString("quick", ""),
                )
            } else {
