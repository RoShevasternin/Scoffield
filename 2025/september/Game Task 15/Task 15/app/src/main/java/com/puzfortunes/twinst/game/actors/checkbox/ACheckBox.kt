package com.puzfortunes.twinst.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.MUS -> ACheckBoxStyle(
            default = gdxGame.assetsAll.mus_on,
            checked = gdxGame.assetsAll.mus_off,
        )

        Type.SOU -> ACheckBoxStyle(
            default = gdxGame.assetsAll.sou_on,
            checked = gdxGame.assetsAll.sou_off,
        )
    }
