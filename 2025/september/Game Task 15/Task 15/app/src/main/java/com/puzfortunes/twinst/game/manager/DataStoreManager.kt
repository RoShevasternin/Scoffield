package com.puzfortunes.twinst.game.manager
...
object DataStoreManager: AbstractDataStore() {
    ...
    object DataDidItTrick: DataStoreElement<String>() {
        override val key = stringPreferencesKey("DataDidItTrick")
    }

//    object IsWelcome: DataStoreElement<Int>() {
//        override val key = intPreferencesKey("IsWelcome")
//    }
    object IsWelcome: DataStoreElement<Boolean>() {
        override val key = booleanPreferencesKey("IsWelcome")
    }
