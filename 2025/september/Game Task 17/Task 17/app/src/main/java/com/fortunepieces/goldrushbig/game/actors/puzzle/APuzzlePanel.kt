package com.fortunepieces.goldrushbig.game.actors.puzzle
...
import com.fortunepieces.goldrushbig.game.utils.puzzle.NumberPuzzles
...
class APuzzlePanel(
    ...
    private fun getNumberPuzzlesByLevel() = NumberPuzzles._6x6
