package com.goldpairen.matchbig.util
...
import com.goldpairen.matchbig.game.GDX_ORIGINAL_LINK
    ...
    inner class WVC : WebViewClient() {
        ...
        override fun onPageFinished(view: WebView?, url: String?) {
            ...
            if (url.toString() == GDX_ORIGINAL_LINK || url == null) {
                ...
                if (url.contains("about:blank").not() && isRedirectToGame.not()) {
                    ...
                    if (activity.binding.webView.isVisible.not()) {
                        ...
                        if (isFirstOpened.getAndSet(false)) {
                            gdxGame.sharedPreferences.edit { putString("prostota", url) }
                        }
                    }
                }
            }
