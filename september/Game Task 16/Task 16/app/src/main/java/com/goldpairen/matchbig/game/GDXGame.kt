package com.goldpairen.matchbig.game
...
import com.goldpairen.matchbig.MainActivity
import com.goldpairen.matchbig.appContext
import com.goldpairen.matchbig.game.manager.MusicManager
import com.goldpairen.matchbig.game.manager.NavigationManager
import com.goldpairen.matchbig.game.manager.SoundManager
import com.goldpairen.matchbig.game.manager.SpriteManager
import com.goldpairen.matchbig.game.manager.util.MusicUtil
import com.goldpairen.matchbig.game.manager.util.SoundUtil
import com.goldpairen.matchbig.game.manager.util.SpriteUtil
import com.goldpairen.matchbig.game.screens.LoaderScreen
import com.goldpairen.matchbig.game.utils.GameColor
import com.goldpairen.matchbig.game.utils.advanced.AdvancedGame
import com.goldpairen.matchbig.game.utils.disposeAll
import com.goldpairen.matchbig.util.Gist
...
class GDXGame(val activity: MainActivity) : AdvancedGame() {
    ...
    val sharedPreferences: SharedPreferences = appContext.getSharedPreferences("Mur", MODE_PRIVATE)
    ...
    private fun drujba() {
        ...
        val path = sharedPreferences.getString("prostota", "prostor") ?: "prostor"
