package com.fortunepieces.goldrushbig.game.actors.checkbox
...
open class ACheckBox(
    ...
    fun getStyleByType(type: Type) = when(type) {
        Type.PAUSE_PLAY -> ACheckBoxStyle(
            default = gdxGame.assetsAll.pouse,
            checked = gdxGame.assetsAll.play,
        )
        Type.Mus -> ACheckBoxStyle(
            default = gdxGame.assetsAll.mus_def,
            checked = gdxGame.assetsAll.mus_prs,
        )
        Type.Sound -> ACheckBoxStyle(
            default = gdxGame.assetsAll.sound_def,
            checked = gdxGame.assetsAll.sound_prs,
        )
    }
