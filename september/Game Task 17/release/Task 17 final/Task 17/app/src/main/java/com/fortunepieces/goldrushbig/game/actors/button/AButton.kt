package com.fortunepieces.goldrushbig.game.actors.button
...
import com.fortunepieces.goldrushbig.game.utils.TextureEmpty
...
open class AButton(
    ...
    private fun getStyleByType(type: Type) = when(type) {
        ...
        Type.Left -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.left_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.left_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.left_prs),
        )
        Type.Right -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.right_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.right_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.right_prs),
        )
        Type.Back -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.back_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.back_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.back_prs),
        )
        Type.Play -> AButtonStyle(
            default  = TextureRegionDrawable(gdxGame.assetsAll.pl_def),
            pressed  = TextureRegionDrawable(gdxGame.assetsAll.pl_prs),
            disabled = TextureRegionDrawable(gdxGame.assetsAll.pl_prs),
        )
    }
