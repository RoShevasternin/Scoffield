package com.puzfortunes.twinst.game.utils.actor
...
import com.puzfortunes.twinst.game.utils.SizeScaler
import com.puzfortunes.twinst.game.utils.TIME_ANIM_SCREEN
import com.puzfortunes.twinst.game.utils.runGDX
...
fun Actor.setBounds(posSize: PosSize) {
    setBounds(posSize.x, posSize.y, posSize.w, posSize.h)
}
...
fun Actor.setBoundsScaled(sizeScaler: SizeScaler, posSize: PosSize) {
    setBoundsScaled(sizeScaler, posSize.x, posSize.y, posSize.w, posSize.h)
}
